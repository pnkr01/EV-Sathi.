...
import 'package:ev_station/src/models/nearby_ev_station_results.dart';
import 'package:ev_station/src/screen/MarkerContainer/available_connectors.dart';
...
class _MapPageState extends State<MapPage> {
  ...
  Future<List<NearbyEVStationResults>> getNearby(
    ...
    var response = await https.get(
      Uri.parse(
        "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=$latitude,$longitude&radius=30000&type=electric_vehicle_charging_station&keyword=electric_vehicle_charging_station&key=${sharedPreferences!.getString('key')}",
      ),
    );
